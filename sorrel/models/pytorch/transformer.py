...
class PatchEmbedding(nn.Module):
    ...
    def __init__(
        ...
        self.proj1 = nn.Sequential(Rearrange('b t c (h p1) (w p2) -> (b t) (h w) (p1 p2 c)', p1=p, p2=p))
...
class ViTOneHot(VisionTransformer):
    ...
    def __init__(
        ...
        super(VisionTransformer, self).__init__(state_size, action_space, layer_size, patch_size, num_frames, batch_size, num_layers, num_heads, memory, LR, device, seed)
