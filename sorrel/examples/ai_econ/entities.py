...
#         self.sprite = Path(__file__).parent / f"./assets/wall.png"
...
#         super().__init__()
#         self.passable = True
#         self.sprite = Path(__file__).parent / f"./assets/empty.png"
...
#     def __init__(self):
#         super().__init__()
#         self.sprite = Path(__file__).parent / f"./assets/grass.png"


# # Entities on layer 1 (middle layer)


# class WoodNode(Entity["EconWorld"]):
...
#         self.renew_chance = config.env.resource_renew_chance
#         self.renew_amount = config.env.resource_renew_amount
...
#             self.kind = "WoodNode"
#             self.sprite = Path(__file__).parent / f"./assets/wood.png"
...
# class StoneNode(Entity["EconWorld"]):
...
#             self.num_resources = self.renew_amount
#             self.kind = "StoneNode"
#             self.sprite = Path(__file__).parent / f"./assets/stone.png"
