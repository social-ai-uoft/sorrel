...
class StagHuntMetricsCollector:
    ...
    def log_epoch_metrics(
        self, agents: List[StagHuntAgent], epoch: int, writer
    ) -> None:
        ...
        for agent in agents:
            ...
            writer.add_scalar(
                f"Agent_{agent_id}/punishments_given",
                agent_data["punishments_given"],
                epoch,
            )
            writer.add_scalar(
                f"Agent_{agent_id}/punishments_received",
                agent_data["punishments_received"],
                epoch,
            )
            writer.add_scalar(
            ...
            writer.add_scalar(
                f"Agent_{agent_id}/attack_cost_paid",
                agent_data["attack_cost_paid"],
                epoch,
            )
            writer.add_scalar(
                f"Agent_{agent_id}/punish_cost_paid",
                agent_data["punish_cost_paid"],
                epoch,
            )
            writer.add_scalar(
            ...
            writer.add_scalar(
                f"Agent_{agent_id}/shared_rewards_received",
                agent_data["shared_rewards_received"],
                epoch,
            )
            ...
            for target_agent_id, count in agent_data["punishments_to_agent"].items():
                writer.add_scalar(
                    f"Agent_{agent_id}/punishments_to_agent_{target_agent_id}",
                    count,
                    epoch,
                )
        ...
        writer.add_scalar(
            "Total/total_punishments_given", total_punishments_given, epoch
        )
        writer.add_scalar(
            "Total/total_punishments_received", total_punishments_received, epoch
        )
        ...
        if num_agents > 0:
            ...
            writer.add_scalar(
                "Mean/mean_punishments_given",
                total_punishments_given / num_agents,
                epoch,
            )
            writer.add_scalar(
                "Mean/mean_punishments_received",
                total_punishments_received / num_agents,
                epoch,
            )
            writer.add_scalar("Mean/mean_rewards", total_rewards / num_agents, epoch)
            writer.add_scalar(
                "Mean/mean_attack_costs", total_attack_costs / num_agents, epoch
            )
            writer.add_scalar(
                "Mean/mean_punish_costs", total_punish_costs / num_agents, epoch
            )
            writer.add_scalar(
            ...
            writer.add_scalar(
                "Mean/mean_shared_rewards", total_shared_rewards / num_agents, epoch
            )
        ...
        writer.add_scalar(
            "Global/Total_Punishments", self.epoch_metrics["total_punishments"], epoch
        )
        writer.add_scalar("Global/Average_Clustering", clustering, epoch)
