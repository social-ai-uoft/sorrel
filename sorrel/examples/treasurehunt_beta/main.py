...
if __name__ == "__main__":
    ...
    print(
        f"Resource values - Gem: {config['world']['gem_value']}, Apple: {config['world']['apple_value']}, Coin: {config['world']['coin_value']}, Bone: {config['world']['bone_value']}, Food: {config['world']['food_value']}"
    )
