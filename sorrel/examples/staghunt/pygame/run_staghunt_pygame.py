...
This script provides an easy way to run the pygame version with different
configurations.
"""
...
from sorrel.examples.staghunt.pygame.staghunt_pygame import StagHuntPygame
...
def main():
    ...
    if choice == "1":
        ...
        try:
            ...
            width, height, cell_size = 11, 11, 50
        config = {
            "world": {
                "height": height,
                "width": width,
