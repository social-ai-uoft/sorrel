...
Sets up a simple chess game between white and black. For now, agents act with a
random policy.
"""
...
from sorrel.examples.chess.entities import King, Queen, Bishop, Knight, Rook, Pawn
...
class ChessEnvironment(Environment[ChessWorld]):
    ...
    def setup_agents(self) -> None:
        ...
        for colour in ["white", "black"]:
            agents.append(
                make_random_chess_agent(colour=colour, world=self.world)
            )
        self.agents = agents
