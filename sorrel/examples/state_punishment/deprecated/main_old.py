...
from sorrel.examples.state_punishment.logger import (
    StatePunishmentLogger as ModularLogger,
)
...
def main_simplified():
    ...
    parser = argparse.ArgumentParser(
        description="Run state punishment experiments (simplified)"
    )
    ...
    multi_agent_env.run_experiment(
        animate=False, logging=True, logger=logger, output_dir=log_dir
    )
