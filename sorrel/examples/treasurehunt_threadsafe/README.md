...
A game where one or more agents explore to find valuable items (food, gems) and avoiding punishment items (bones). Copy of the examples/treasurehunt environment using threadsafe models instead. 

## Running the example

```bash
python sorrel/examples/treasurehunt_threadsafe/main.py
```
