...
# begin treasurehunt_theta agent
class TreasurehuntThetaAgent(Agent[TreasurehuntThetaWorld]):
    """A treasurehunt_theta agent that uses the iqn model."""
    ...
    def pov(self, world: TreasurehuntThetaWorld) -> np.ndarray:
    ...
    def act(self, world: TreasurehuntThetaWorld, action: int) -> float:
    ...
    def is_done(self, world: TreasurehuntThetaWorld) -> bool:
