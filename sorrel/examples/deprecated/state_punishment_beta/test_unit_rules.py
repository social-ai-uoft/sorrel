...
from sorrel.examples.state_punishment_beta.main import create_config
...
class TestEntitySystem(unittest.TestCase):
    ...
    def test_entity_spawning_probabilities(self):
        ...
        config = create_config(use_composite_views=False, use_composite_actions=False, 
                             use_multi_env_composite=False, num_agents=2, epochs=1)
...
class TestWorldMechanics(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test world."""
        self.config = create_config(use_composite_views=False, use_composite_actions=False, 
                                  use_multi_env_composite=False, num_agents=2, epochs=1)
        self.world = StatePunishmentWorld(config=self.config, default_entity=EmptyEntity())
    ...
    def test_world_initialization(self):
        ...
        self.assertEqual(self.world.map.shape, (self.config['world']['height'], self.config['world']['width'], 1))
...
class TestAgentBehavior(unittest.TestCase):
    ...
    def test_observation_space(self):
        ...
        self.assertEqual(len(self.agent.observation_spec.input_size), 3)  # height, width, channels
...
class TestCompositeFeatures(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.config = create_config(use_composite_views=True, use_composite_actions=True, 
                                  use_multi_env_composite=True, num_agents=2, epochs=1)
        self.world = StatePunishmentWorld(config=self.config, default_entity=EmptyEntity())
        self.env = StatePunishmentEnv(self.world, self.config)
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_single_agent_composite(self):
        ...
        config = create_config(use_composite_views=True, use_composite_actions=True, 
                             use_multi_env_composite=True, num_agents=1, epochs=1)
    ...
    def test_zero_agents(self):
        ...
        config = create_config(use_composite_views=False, use_composite_actions=False, 
                             use_multi_env_composite=False, num_agents=0, epochs=1)
