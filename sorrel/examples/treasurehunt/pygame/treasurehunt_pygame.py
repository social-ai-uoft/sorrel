...
import pygame
import numpy as np
from sorrel.examples.treasurehunt.entities import EmptyEntity, Sand, Wall, Gem
...
class TreasurehuntPygame:
    ...
    def move_player(self, action_name):
        ...
        if action_name == "up":
            new_location = (current_location[0] - 1, current_location[1], current_location[2])
        elif action_name == "down":
            new_location = (current_location[0] + 1, current_location[1], current_location[2])
        elif action_name == "left":
            new_location = (current_location[0], current_location[1] - 1, current_location[2])
    ...
    def is_valid_location(self, location):
        ...
        if (location[0] < 0 or location[0] >= self.world.height or
            location[1] < 0 or location[1] >= self.world.width):
            return False
    ...
    def spawn_random_gem(self):
        ...
        if empty_locations:
            ...
            self.world.add(empty_locations[gem_location], Gem(self.config["world"]["gem_value"]))
