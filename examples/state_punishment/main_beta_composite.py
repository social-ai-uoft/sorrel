...
def run(cfg, **kwargs):
    ...
    for count, agent in enumerate(agents):
        agent.model.load(f'{root}/examples/state_punishment/models/checkpoints/test_voting_stacked_views_composite_actions_3agents_v0_agent{agent.ixs}_iRainbowModel.pkl')
