...
class EmptyObject(Entity):
    ...
    def __init__(self, appearance, cfg):
        ...
        self.sprite = f'{cfg.root}/examples/puppet_training/assets/white.png'
    ...
    def transition(self, env):
        '''
        Transition function for EmptyObjects in the puppet_training environment. 
...
class Wall(Entity):
    ...
    def __init__(self, appearance, cfg):
        ...
        self.sprite = f'{cfg.root}/examples/puppet_training/assets/pink.png'
        self.type = 'wall'
...
class Gem(Entity):
    ...
    def __init__(self, appearance, cfg):
        ...
        self.passable = True
        self.sprite = f'{cfg.root}/examples/puppet_training/assets/gem.png'
...
#         self.passable = True
#         self.sprite = f'{cfg.root}/examples/puppet_training/assets/coin.png'
...
#         self.passable = True
#         self.sprite = f'{cfg.root}/examples/puppet_training/assets/food.png'
...
class Bone(Entity):
    ...
    def __init__(self, appearance, cfg):
        ...
        self.sprite = f'{cfg.root}/examples/puppet_training/assets/bone.png'
        self.type = 'bone'

# ----------------------------------------------------- #
# new entities for puppet_training                     #
# ----------------------------------------------------- # 
