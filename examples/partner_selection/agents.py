...
class Agent:
    def __init__(self, model, partner_selection_model, preferences, variability, cfg, ixs):
        self.kind = "Agent"
        self.type = 'agent'
        self.cfg = cfg    
        ...
        self.task_model = model  # agent model here. need to add a tad that tells the learning somewhere that it is DQN
        self.partner_choice_model = partner_selection_model
    ...
    def transition(self,
        ...
        selected_partner = partner_choices[self.movement(action)]
